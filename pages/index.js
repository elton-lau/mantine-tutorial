...
export default function Home() {
  ...
  return (
    <Group direction="column" mt='-30px'>
      <Group style={{ backgroundColor: theme.colors.gray[0], width: "500px", height: "100vh" }} mx="auto" direction="column">
        ...
        <Group spacing="none" mt="sm" position="center" mx="auto" direction="column" height="175px">
          <Title order={1} style={{ fontWeight: "900", fontSize: "4rem" }}>25:00</Title>
          <Text>Record Mantine Tutorial</Text>
        </Group>
        <Group mt="sm" position="center" mx="auto" direction="row" height="200px" mb="medium">
          <ActionIcon color="dark" size='xl' variant="transparent">-5</ActionIcon>
          <ActionIcon color="dark" size='xl' variant="filled" radius="xl">
            <PlayerPlay />
          </ActionIcon>
          <ActionIcon color="dark" size='xl' variant="transparent">+5</ActionIcon>
        </Group>
        <Group my="sm" position="center" mx="auto" direction="column" height="90px">
          <UnstyledButton style={{ height: '100%', width: "260px" }}>
            <Group spacing="none" p="lg" direction="column" mt="sm" mx="auto" position="center"
              style={{ background: "rgb(238, 238, 238)", border: "1px dashed rgb(189, 189, 189)" }}>
                <Box size="md" radis="xs">
